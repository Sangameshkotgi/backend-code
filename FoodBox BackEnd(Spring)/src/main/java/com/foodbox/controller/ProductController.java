...
public class ProductController {
	...
	public List<Product> getAllProducts() {
		...
		if(prodList.isEmpty()) {
			...
			addProdIfEmpty(new Product(3,"Chicken Lollipop","Fried Chicken ","Starters",130,2,0,"yes","./assets/images/lollipop.jpeg"));
			...
			addProdIfEmpty(new Product(5,"Chocolate cake","Sweet","Desserts",50,0,0,"yes","./assets/images/choclate.jpeg"));
